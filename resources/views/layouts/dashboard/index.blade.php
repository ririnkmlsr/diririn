...
<html lang="en">
  ...
  <div class="container ">
        ...
        <span class="navbar-brand mb-0 h1">RIRIN</span>
        ...
        <div class="card-body" >
            <div style="height:600px;overflow:auto;margin-right:15px;">
                    ...
                    <tr>
                        ...
                        <td> <?php echo $idprovinsi[$i]['attributes']['Kasus_Positif'] ?></td>
                        <td> <?php echo $idprovinsi[$i]['attributes']['Kasus_Sembuh'] ?></td>
                        <td> <?php echo $idprovinsi[$i]['attributes']['Kasus_Meninggal'] ?></td>
                    </tr>
                        <?php 
